              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-700/50">
                    <tr>
                      <th className="px-6 py-4 text-left bg-gray-800 text-gray-300 font-medium">Product</th>
                      <th className="px-6 py-4 text-center bg-gray-800 text-gray-300 font-medium">Price</th>
                      <th className="px-6 py-4 text-center bg-gray-800 text-gray-300 font-medium">Stock</th>
                      <th className="px-6 py-4 text-center bg-gray-800 text-gray-300 font-medium">Quantity</th>
                      <th className="px-6 py-4 text-center bg-gray-800 text-gray-300 font-medium">Action</th>
                    </tr>
                  </thead>
